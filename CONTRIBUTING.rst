...
Report bugs at https://github.com/loucerac/malmstin/issues
...
https://github.com/loucerac/malmstin/issues.
...
Ready to contribute? Here's how to set up `malmstin` for local
development. Please note this documentation assumes you already have
`PDM` and `Git` installed and ready to go.

| 1. Fork the `malmstin` repo on GitHub.
...
| 2. Clone your fork locally:
   ...
   .. code-block:: bash
        ...
        git clone git@github.com:YOUR_NAME/malmstin.git
